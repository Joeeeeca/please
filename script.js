...
function startCountdown($resultElement) {
    ...
    var countdownInterval = setInterval(function() {
        ...
        if (countdown <= 0) {
            ...
            // Show #subscribe-result1 after the countdown ends
        ...
        $.ajax({
            ...
            success: function(data){
                if (data.result != "success") {
                    ...
                    // Start countdown only for #subscribe-form
...
$(document).ready(function() {
    ...
    $('#close-popup').click(function() {
        hidePopupOverlay();
        // Set the cookie to indicate that the form has been submitted successfully
        setCookie("subscriptionFormSubmitted", "true", 30); // Cookie expires in 30 days
    });
});
