        ...
        $.ajax({
            ...
            success: function(data){
                if (data.result != "success") {
                    ...
                    // Set sessionStorage upon successful subscription
                    setSessionStorage("subscriptionFormSubmitted", "true");
...
function checkCookie(cookieName, expectedValue) {
    ...
    if (cookieValue === "" && checkSessionStorage(cookieName)) {
        return true;
    }
...
// Function to check if a key exists in sessionStorage
function checkSessionStorage(key) {
    return sessionStorage.getItem(key) === "true";
}

// Function to control the visibility of elements based on sessionStorage
function manageSubscriptionFormVisibility() {
    if (checkSessionStorage("subscriptionFormSubmitted")) {
        $('#popup-overlay').css('display', 'none');
        $('#subscribe-form1').hide();
...
$(document).ready(function() {
    // Check the sessionStorage when the page loads
