document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("second-chance-subscribe-form").addEventListener("submit", function (event) {
      ...
      var form = document.getElementById("second-chance-subscribe-form");
      form.submit();
